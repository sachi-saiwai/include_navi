                  ...
                  children: <Widget>[
                    ...
                    _HomeHero(
                      ...
                      onAddChild: () {
                        Navigator.of(
                          context,
                        ).pushNamed(ChildFormScreen.routeName);
                      },
                    ),
        ...
        if (isNarrow) {
          return Column(
            children:
                children
                    .expand(
                      (widget) => <Widget>[widget, const SizedBox(height: 12)],
                    )
                    .toList()
                  ..removeLast(),
          );
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Icon(icon, color: const Color(0xFF1E2B2C)),
          ),
          const SizedBox(height: 14),
          Text(
            title,
...
class _InfoPill extends StatelessWidget {
  const _InfoPill({required this.icon, required this.label, this.secondary});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Icon(icon, size: 18, color: const Color(0xFF006A6B)),
